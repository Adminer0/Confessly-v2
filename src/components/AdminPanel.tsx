            ...
            >
              ...
              <div className="bg-white border border-slate-200 rounded-3xl p-5 space-y-4 shadow-xl shadow-slate-200/50">
                <div className="flex flex-col md:flex-row gap-3">
                  ...
                  <div className="flex bg-slate-100 border border-slate-200 p-1 rounded-xl relative z-0">
                    <button
                      onClick={() => setFilterStatus('pending')}
                      className={`relative px-4 py-1.5 rounded-lg text-xs font-semibold transition-colors cursor-pointer ${
                        filterStatus === 'pending' ? 'text-white' : 'text-slate-600 hover:text-slate-800'
                      }`}
                    >
                      Pending Queue
                    ...
                    <button
                      ...
                      className={`relative px-4 py-1.5 rounded-lg text-xs font-semibold transition-colors cursor-pointer ${
                        filterStatus === 'approved' ? 'text-white' : 'text-slate-600 hover:text-slate-800'
                      }`}
                    >
                      Approved
                    ...
                    <button
                      ...
                      className={`relative px-4 py-1.5 rounded-lg text-xs font-semibold transition-colors cursor-pointer ${
                        filterStatus === 'deleted' ? 'text-white' : 'text-slate-600 hover:text-slate-800'
                      }`}
                    >
                      Trash Folder
          ...
          {showShareModal && (
            ...
            >
              <motion.div 
                ...
                exit={{ scale: 0.9, opacity: 0 }}
                transition={{ type: "spring", stiffness: 350, damping: 25 }}
                className="bg-white w-full max-w-lg rounded-3xl shadow-2xl p-6 relative overflow-hidden space-y-6"
              >
                <button
