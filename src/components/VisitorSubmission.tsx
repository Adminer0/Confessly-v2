            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-2">
                ...
                <motion.div 
                  ...
                  className={`rounded-2xl p-5 border shadow-lg transition-all duration-500 ${activeThemeObj.bgClass} ${activeThemeObj.borderClass}`}
                >
                  <div className="flex justify-between items-center mb-3">
                    <motion.span 
                      layout="position"
                      className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] uppercase tracking-wider font-bold ${activeThemeObj.badgeClass}`}
                    >
                      {CATEGORY_EMOJIS[selectedCategory]} {selectedCategory}
                    </motion.span>
                    <motion.span 
                      layout="position"
                      className={`text-[11px] font-mono opacity-80 ${activeThemeObj.textClass}`}
                    >
                  ...
                  <motion.p 
                    layout="position"
                    className={`text-base font-medium italic min-h-[50px] leading-relaxed break-words ${activeThemeObj.textClass}`}
                  >
